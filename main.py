...
def run_backend(cfg, model, states, keyframes, K, q):
    ...
    #q.put(("ba_stats", backend_stats))      # ä°ˆpn^ﬁ
    #q.put(backend_stats)
...
if __name__ == "__main__":
    ...
    backend2main = manager.Queue()        # ê ∞ûØπÑ multiprocessing.Queue
    ...
    try:
        ...
        print("=Ä TensorRTœ!ãÚ/( - Ñ3.31x†")
    except Exception as e:
        print(f"œ!ã†}1%(üÀ!ã: {e}")
        model = load_mast3r(device=device)
    ...
    while True:
        ...
        try:
            ...
            pass
        #print("QUEUE SIZE", backend2main.qsize())   # 	°	ﬁY
